...
public class AddProductScreenController implements Initializable {
    ...
    @FXML void addButtonPressed(ActionEvent event) {
        ...
        if (part == null) {
            ...
            addButtonAssociatedPart(part);
            addedResultsTableView.setItems(getAllAssociatedPartsFromAddButton());
        }
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // sets the product ID with an auto incrementation
        productID = Inventory.increaseProductID();
